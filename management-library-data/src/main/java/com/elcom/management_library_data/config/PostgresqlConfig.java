...
package com.elcom.management_library_data.config;
...
@EnableJpaRepositories(
        ...
        basePackages = {"com.elcom.management_library_data.postgresql.repository"}
)
public class PostgresqlConfig {
    ...
    public LocalContainerEntityManagerFactoryBean postgresqlEntityManagerFactory(@Qualifier("postgresqlDataSource") DataSource hubDataSource, EntityManagerFactoryBuilder builder) {
        return builder.dataSource(hubDataSource).packages("com.elcom.management_library_data.postgresql.model")
